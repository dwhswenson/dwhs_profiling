...
def write_version_py(filename='dwhs_profiling/version.py'):
    cnt = """
...
def buildKeywordDictionary():
    ...
    setupKeywords = {}
    setupKeywords["name"]              = "dwhs_profiling"
    ...
    setupKeywords["download_url"]      = "http://github.com/dwhswenson/dwhs_profiling"
    setupKeywords["packages"]          = ['dwhs_profiling']
    setupKeywords["package_dir"]       = {
        'dwhs_profiling' : 'dwhs_profiling'
    }
